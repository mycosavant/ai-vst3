...
class DJAILL:
    ...
    def _build_prompt(self):
        ...
        return f"""Generate a music sample based on these keywords: {user_prompt}
...
- Key: {current_key}"""
    ...
    def get_system_prompt(self) -> str:
        return """You are a music sample generator AI specialized in creating MusicGen prompts.

Your task: Transform user keywords into effective MusicGen prompts.

RULES:
- Create descriptive, tag-based prompts optimized for audio generation
- Use musical terminology (genre, instruments, mood, rhythm)
- Keep prompts concise but descriptive
- Suggest an appropriate musical key or use the provided one

EXAMPLES:
Keywords: "deep techno rhythm kick hardcore"
→ musicgen_prompt: "deep techno kick drum, hardcore rhythm, driving 4/4 beat, industrial"
→ key: "C minor"

Keywords: "ambient space"
→ musicgen_prompt: "ambient atmospheric space soundscape, ethereal pads, cosmic textures"
→ key: "A minor"

Keywords: "jazzy piano"
→ musicgen_prompt: "jazz piano, smooth chords, melodic improvisation, bebop style"
→ key: "Bb major"
"""
